...
#define CPU_CLOCK_DEVIATION_POSITIVE   (1.01) // default 1.01
#define CPU_CLOCK_DEVIATION_NEGATIVE   (7.99) // default 1.99 but from 3.99 work OK on Arduino UNO
#define SHA204_RETRY_COUNT             (1) // Default 1
